...
L’alchimiste lance une potion toutes les 1,5 s à 5,5 cases : 13,5 dégâts magiques au point d’impact, puis 60 % sur trois autres ennemis au maximum dans un rayon de 1,6 case. Les obstacles bloquent les tirs, les alliés ne subissent pas les explosions. Il soigne automatiquement un allié blessé à 4 cases de 25 PV toutes les 8 s ; un ordre de déplacement reste prioritaire. Le solvant conserve sa synergie avec le feu. L’armure passive réduit les dégâts physiques (chevalier 25 %, lancier humain 15 %, troll 15 %, minotaure 20 %, squelette 10 %) ; magie et feu l’ignorent, les boucliers actifs restent efficaces.

Les maisons et bâtiments humains déploient leurs défenseurs dans la rue lorsqu’une attaque approche. Il n’y a plus de riposte invisible du bâtiment. La mairie déploie les quatre rôles humains avec un niveau supplémentaire (plafond 6), 20 % de PV supplémentaires et une taille visuelle accrue. Le Faubourg conserve des défenseurs affaiblis pour l’apprentissage. Le compteur d’armée permanent indique les places occupées et réservées par les recrutements, à gauche du compteur des gobelins.
