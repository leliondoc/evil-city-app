...
Sur ordinateur, un menu circulaire en bas à droite reprend les textures et icônes du pack UI, sans cadres carrés derrière les icônes ni anneaux décoratifs supplémentaires. Son centre affiche le niveau du manoir et permet de le sélectionner ; les boutons accolés au cercle sélectionnent l’armée (hors gobelins bâtisseurs), ouvrent le bestiaire, le guide et les paramètres, ou mettent en pause. Les cartes sont centrées entre la horde et ce menu. Les sept cartes de recrutement utilisent un format portrait et tiennent sur une rangée dès 1440 pixels ; sur les écrans étroits, la molette, le geste tactile et les grandes flèches permettent de défiler. Sur mobile, les raccourcis restent dans la barre supérieure pour préserver la place de la carte. Le bestiaire affiche les unités sur fond uni, sans tuiles d’herbe ; le compteur des gobelins garde son texte à pleine opacité sans fond individuel.
